...
export default function CreateChannel({setShowModal}) {
  ...
  return (
    <div>
        ...
        <small>Channels are where your team communicates. They're best when organised around a topic - #marketing, for example.</small>
        <form onSubmit={createNewChannelHandler}>
            ...
            <div>
                ...
                <small>When a channel is set to private, it can only be viewed or joined by invitation.</small>
            </div>
